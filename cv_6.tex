...
\begin{tabularx}{\textwidth}{
 ...
 \raisebox{-.55\height}{\includegraphics[width=3cm]{me.png}} % image baseline is at its bottom
\end{tabularx}
...
\section{Motivations}
 ...
 Je cherche un stage me permettant d'appliquer \`a une fin industrielle mes connaissances en acquisition et traitement de l'information.
 J'aimerais y \^etre au contact de professionnels de la s\'ecurit\'e afin d'approfondir mes connaissances dans ce domaine.
