...
osc.laurent@gmail.com \  06 07 10 92 36\\ % Your email address and phone number
\href{https://fr.linkedin.com/in/oscar-laurent-52878215}{LinkedIn}
}
...
& Apprentissage d'algorithmes avançés (A*, pathfinding) \\
& Partenariat avec l'Institut Français de la Mode (scraping, ruby)
% 
\end{tabularx}
...
& Analyses statistiques de modélisations moléculaires \\
& (structures locales et à moyenne portée) de syst\`emes vitreux
\end{tabularx}
